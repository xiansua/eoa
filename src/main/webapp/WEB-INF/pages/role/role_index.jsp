					...
					<div class="col-sm-12 col-md-12">
						<form id="form_search">
							<div class="form-row align-items-center">
								...
								<div class="col-auto my-1">
									<input type="text" class="form-control" name="roleName" placeholder="管理员名称">
								</div>
								<div class="col-auto my-1">
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">管理员<span id="action_info"></span></h5>
			...
			<div class="modal-body">
					<div class="form-group row">
						<label class="col-sm-2 col-form-label">管理员名称</label>
						<div class="col-sm-7">
							<input type="text" class="form-control validate[required,ajax[ajaxRoleName]]"
					...
					<div class="form-group row">
						...
						<div class="col-sm-7">
							<select class="form-control validate[required]" name="roleKind" id="roleKind">
								<option value="1">一级</option>
								<option value="2">二级</option>
								<option value="3">三级</option>
							</select>
					...
					<div class="form-group row">
						<label class="col-sm-2 col-form-label">管理员简介</label>
						<div class="col-sm-7">
							<textarea  class="form-control validate[required]" name="roleInfo" id="roleInfo"></textarea>
						</div>
					</div>
