			...
			<div class="top center">
				<div class="left fl">
					<ul>
						...
						<li>|</li>
						<li><a href="liebiao.jsp">MIUI</a></li>
						<li>|</li>
						<li><a href="liebiao.jsp">米聊</a></li>
						<li>|</li>
						<li><a href="liebiao.jsp">游戏</a></li>
						<li>|</li>
						<li><a href="liebiao.jsp">多看阅读</a></li>
						<li>|</li>
						<li><a href="liebiao.jsp">云服务</a></li>
						<li>|</li>
						<li><a href="liebiao.jsp">金融</a></li>
						<li>|</li>
						<li><a href="liebiao.jsp">小米商城移动版</a></li>
						<li>|</li>
						<li><a href="">问题反馈</a></li>
						<li>|</li>
				...
				<div class="right fr">
					...
					<div class="fr">
						<ul>
							...
							<li>|</li>
							<li><a href="admin_login.jsp" >管理员登陆</a></li>
							<li>|</li>
							<li><a href="">消息通知</a></li>
						</ul>
					</div>
						...
						<div class="pop">
							<div class="left fl">
								<div>
									...
									<div class="xuangou_right fr"><a href="xiangqing.jsp" >选购</a></div>
									<div class="clear"></div>
								</div>
								<div>
									<div class="xuangou_left fl">
